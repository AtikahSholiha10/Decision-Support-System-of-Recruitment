...
<head>
    <meta charset="utf-8" />
    <title><?= $_GET['module'] ?> - Portal Admin</title>
...
<body class="loading" data-layout='{"mode": "light", "width": "fluid", "menuPosition": "fixed", "sidebar": { "color": "brand", "size": "default", "showuser": true}, "topbar": {"color": "light"}, "showRightSidebarOnPageLoad": true}'>
    <!-- Begin page -->
    <div id="wrapper" <?php if(($_GET['module']==='transaksi') AND ($_GET['act']==='detail-invoice')){ echo "class='p-0 my-0'"; } ?>>
        <!-- Topbar Start -->
        ...
        <div class="content-page <?php if(($_GET['module']==='transaksi') AND ($_GET['act']==='detail-invoice')){ echo 'p-0 my-0'; } ?>">
            <!-- content -->
    ...
    <!-- Plugins js-->
        ...
        <script>
            function confirmHapusPenerimaan(enkripsi) {
                Swal.fire({
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        window.location = "<?= $base_url_admin ?>/actionDeletePenerimaan/" + enkripsi;
