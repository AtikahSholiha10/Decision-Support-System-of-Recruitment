<?php
    ...
    $penyimpananGambar  = "$base_url/assets/files/images";
    $database           = "pengaturan";
    $link               = "pengaturan";
?>
                                ...
                                <table class="table table-striped table-bordered mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a role="button" data-bs-toggle="modal" data-bs-target="#UbahPengaturan<?= $result['id_pengaturan'] ?>" class="btn btn-sm btn-success"><i class="fas fa-edit"></i> Ubah</a>
                                                    ...
                                                    <div class="modal-dialog modal-lg">
                                                        <form action="<?= $base_url_admin ?>/editPengaturan" method="POST" data-parsley-validate="" class="modal-content" enctype="multipart/form-data">
                                                            ...
                                                            <div class="modal-body row">
                                                                ...
                                                                <div class="col-md-12 my-1">
                                                                    <div class="form-floating">
                                                                        <input type="text" class="form-control" id="judul" name="in_judul" placeholder="Cth: Beranda" value="<?= $result['judul']; ?>" required="">
                                                                ...
                                                                <?php if ($result['jenis_pengaturan']==="Gambar"): ?>
                                                                    <div class="col-12 my-3">
                                                                        <div class="form-floating">
                                                                            <input type="file" data-plugins="dropify" data-default-file="<?= $penyimpananGambar ?>/<?= $result['gambar'] ?>" data-height="300" id="gambar" accept="image/webp, image/jpeg, image/jpg, image/png, image/gif" name="in_gambar">
                                                                ...
                                                                <?php elseif ($result['jenis_pengaturan']==="Deskripsi"): ?>
                                                                    <div class="col-md-12 my-1">
                                                                        <div class="form-floating">
                                                                            <input type="text" class="form-control" id="deskripsi" name="in_deskripsi" placeholder="Cth: Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua." value="<?= $result['deskripsi']; ?>" required="">
                                                                ...
                                                                <?php elseif ($result['jenis_pengaturan']==="Teks"): ?>
                                                                    <div class="col-md-12 my-1">
                                                                        <div class="form-floating">
                                                                            <input type="text" class="form-control" id="deskripsi" name="in_deskripsi" placeholder="Cth: 0816 9070 19" value="<?= $result['deskripsi']; ?>" required="">
                                                                ...
                                                                <?php elseif ($result['jenis_pengaturan']==="Textarea"): ?>
                                                                    <div class="col-md-12 my-1">
                                                                        <div class="form-floating">
                                                                            <textarea class="form-control" id="deskripsi" name="in_deskripsi" placeholder="Cth: 0816 9070 19" style="height: 250px" required=""><?= $result['deskripsi'] ?></textarea>
                                                                            <label for="deskripsi">Masukkan <?= $result['judul'] ?></label>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <input type="hidden" name="in_id_pengaturan" value="<?= $result['id_pengaturan']; ?>">
                                                                <input type="hidden" name="in_jenis_pengaturan" value="<?= $result['jenis_pengaturan']; ?>">
                                                                <input type="hidden" name="in_gambar_lama" value="<?= $result['gambar']; ?>">
