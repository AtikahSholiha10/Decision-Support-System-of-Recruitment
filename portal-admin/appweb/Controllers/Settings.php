    ...
    if (empty($_SESSION['_session__'])) {
        ...
        switch ($_GET['act']) {
            case "edit-pengaturan":
                ...
                $id_pengaturan      = htmlspecialchars($_POST['in_id_pengaturan']);
                $judul              = $_POST['in_judul'];
                $jenis_pengaturan   = $_POST['in_jenis_pengaturan'];
                ...
                if ($jenis_pengaturan==="Gambar") {
                    // Gambar
                        ...
                        $in_gambar_lama     = $_POST['in_gambar_lama'];
                    ...
                    $deskripsiE = explode('<p data-f-id="pbf" style="text-align: center; font-size: 14px; margin-top: 30px; opacity: 0.65; font-family: sans-serif;">Powered by <a href="https://www.froala.com/wysiwyg-editor?pb=1" title="Froala Editor">Froala Editor</a></p>', $_POST['in_deskripsi']);
